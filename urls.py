...
urlpatterns = urlpatterns + patterns('',
    ...
    (r'^static/(?P<path>.*)$', 'django.views.static.serve', {'document_root': '/home/berry/git/djangodemo/static'}),
    (r'^images/(?P<path>.*)$', 'django.views.static.serve', {'document_root': '/home/berry/git/djangodemo/static/images'}),    
)
