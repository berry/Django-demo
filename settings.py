...
DATABASE_NAME = '/home/berry/git/djangodemo/djangodemo_db'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'u*onq-80ifbru9^h-y)n$l^rd_yr(#low#!lh+m%x)jsgzywzr'
...
TEMPLATE_DIRS = (
    ...
    "/home/berry/git/djangodemo/templates",
)
